...
class kubernetes::node::params {
  ...
  $kubelet_authorization_webhook_cache_authorized_ttl = undef
  $kubelet_authorization_webhook_cache_unauthorized_ttl = undef
  $kubelet_cadvisor_port = undef
  $kubelet_cert_dir = undef
  $kubelet_cgroup_driver = undef
  $kubelet_cgroup_root = undef
  $kubelet_chaos_chance = undef
  $kubelet_client_ca_file = undef
  ...
  $kubelet_experimental_fail_swap_on = undef
  $kubelet_experimental_kernel_memcg_notification = undef
  $kubelet_experimental_mounter_path = undef
  ...
  $kube_proxy_conntrack_min = undef
  $kube_proxy_conntrack_tcp_timeout_close_wait = undef
  ...
  $kube_proxy_iptables_min_sync_period = undef
